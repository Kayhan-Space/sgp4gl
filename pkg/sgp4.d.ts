...
export class GpuPropagator {
   ...
   */
  propagate_batch(consts: WasmGpuConsts[], times: Float64Array): Promise<any>;
  /**
...
export class WasmElements {
   ...
   */
  static from_tle(name: Uint8Array | null | undefined, line1: Uint8Array, line2: Uint8Array): WasmElements;
  /**
...
export interface InitOutput {
  ...
  readonly wasmelements_from_tle: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
