...
const GpuPropagatorFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_gpupropagator_free(ptr >>> 0, 1)
      );
/**
...
export class GpuPropagator {
  ...
  register_const_set(consts) {
    ...
    const ret = wasm.gpupropagator_register_const_set(
      this.__wbg_ptr,
      ptr0,
      len0
    );
  ...
  propagate_registered_f32(id, times) {
    const ret = wasm.gpupropagator_propagate_registered_f32(
      this.__wbg_ptr,
      id,
      addHeapObject(times)
    );
  ...
  propagate_registered_f64(id, times) {
    const ret = wasm.gpupropagator_propagate_registered_f64(
      this.__wbg_ptr,
      id,
      addHeapObject(times)
    );
   ...
   * @param {WasmGpuConsts[]} consts
   * @param {Float64Array} times
   * @returns {Promise<{position: [number, number, number]; velocity: [number, number, number];}[]>}
   */
  propagate_batch(consts, times) {
    ...
    const ret = wasm.gpupropagator_propagate_batch(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  propagate_batch_f32(consts, times) {
    ...
    const ptr1 = passArrayF64ToWasm0(times, wasm.__wbindgen_export_2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.gpupropagator_propagate_batch_f32(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  propagate_batch_f64(consts, times) {
    ...
    const ptr1 = passArrayF64ToWasm0(times, wasm.__wbindgen_export_2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.gpupropagator_propagate_batch_f64(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
const WasmConstantsFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmconstants_free(ptr >>> 0, 1)
      );
/**
...
const WasmElementsFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmelements_free(ptr >>> 0, 1)
      );
/**
  ...
  static from_tle(name, line1, line2) {
    try {
      ...
      var ptr0 = isLikeNone(name)
        ? 0
        : passArray8ToWasm0(name, wasm.__wbindgen_export_2);
...
const WasmGpuConstsFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmgpuconsts_free(ptr >>> 0, 1)
      );
/**
...
const WasmMinutesSinceEpochFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmminutessinceepoch_free(ptr >>> 0, 1)
      );
/**
...
const WasmPredictionFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmprediction_free(ptr >>> 0, 1)
      );
/**
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbg_copyBufferToBuffer_0d141e7111b0b6ab = function () {
  ...
  imports.wbg.__wbg_createComputePipeline_059cf7af9b47a3fc = function (
    arg0,
    arg1
  ) {
  ...
  imports.wbg.__wbg_dispatchWorkgroups_6558b6463978b7da = function (
    arg0,
    arg1,
    arg2,
    arg3
  ...
  imports.wbg.__wbg_mapAsync_61fd3c4dd9f60c6d = function (
    arg0,
    arg1,
    arg2,
    arg3
  ...
  imports.wbg.__wbg_setBindGroup_2c96f34332734c38 = function () {
  ...
  imports.wbg.__wbg_setBindGroup_5c9e5848197493ea = function (
    arg0,
    arg1,
    arg2
  ) {
  ...
  imports.wbg.__wbg_setbeginningofpasswriteindex_703995fcd4f84112 = function (
    arg0,
    arg1
  ) {
  ...
  imports.wbg.__wbg_setendofpasswriteindex_bbe4757d0b985fd3 = function (
    arg0,
    arg1
  ) {
  ...
  imports.wbg.__wbg_setentrypoint_ec35a2279c4d6dd5 = function (
    arg0,
    arg1,
    arg2
  ) {
  ...
  imports.wbg.__wbg_settimestampwrites_bebe8db3de77d9e1 = function (
    arg0,
    arg1
  ) {
